# Pokemon Red Any% Glitchless (Classic) Advanced Route
...
> Menu to heal if you die to QA and pace allows it  
...
> With 1, 8, or 13 Speed DV - use all remaining Rare Candies on Nido now to make room for the 1 Carbos.    
