...
- Potion if HP is below 11

Pewter Mart
- Buy 8 Potions (7 if you bought 5 balls)
...
- HA + HA or Tackle
- HA x3 (+ HA or Tackle)
- HA x2 (Tackle turn 2 if Weedle hit 2 string shots) (Heal if hp < 4)
- HA x2 + Tackle or finish with HA if Metapod outspeeds you

- if hp < 4 Menu before the next fight and potionx2
...
- MP + (PS)
- MPx2 if zero HAs; otherwise HA + MP (finish with WG if HA crits)
...
- Buy 6 repels and 3 paralyz heals (buy 4 Para Heals if you fought gentleman)

Cut Menu:
- Teach Bubblebeam (TM11) to Nidoking in slot 4
- (only if you fought the Gentleman use the rare candy on Nido)
...
- Teach Thunderbolt (TM24) to Nidoking in slot 3 over HA
- Use Bike
...
- (**on Early Drill only teach slot 2 TM07 Horn Drill over slot 1 MP**)
...
Fly to Celadon
Take the Center, then Bike to Silph
...
* Nidorino: X Acc, HD
* Kangaskhan: HD
* Rhyhorn: BB  (TB stall for a hit w/ 24-37 hp; then BB. If hit by a tail whip, use BB right away)
* Nidoqueen: HD
...
- Cut the 1st tree and the 2nd tree on the left-hand-side to enter the safari zone house.
- Say Yes to enter the Safari Zone and get on the bike right away (cursor is on Pokemon).
...
- then bike to the Safari Warden
...
- Teach **TM14** to Nido in slot 4 over BB
- Use slot 4 **Repel** 
...
After Dropping through the hole menu
- Use Strength
...
If hp is 19+, use Super Potion and Rare Candy
If hp is under 19, use Super Potion, Potion, and Rare Candy
